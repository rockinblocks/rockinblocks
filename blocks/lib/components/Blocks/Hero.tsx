...
export const Hero: FC<IHeroProps> = ({ children, heading, display, subheading ,content }) => (
  <div className="container mx-auto py-16 px-4">
    <div className="flex">
        ...
        <div>
          <div className="my-auto">
            ...
            <div className="flex my-6">
              ...
              <div className="pl-6 border-solid border-l-2 border-l-slate-100">
                <div className="w-36">
                  <svg
      ...
      <div className="flex-1 text-center">Image Placeholder</div>
    </div>
  </div>
);
