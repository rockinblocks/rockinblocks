      ...
      <div className="lg:flex-1 flex flex-col justify-center">
        <div>
          <div className="my-auto">
            ...
            <p className="text-5xl lg:text-8xl font-bold mb-4">{display}</p>
            <p className="text-3xl lg:text-2xl font-semibold text-slate-500 max-w-2xl mb-6">
              {subheading}
            </p>
            <p className="text-xl text-slate-500 max-w-xl mb-6 leading-normal">
              {content}
            </p>
            <div className="flex my-6">
              ...
              <div className="flex pl-6 border-solid border-l-2 border-l-slate-100">
                ...
                <div className="inline">
                  <span className="text-2xl font-semibold pl-2 relative top-1">Vite</span>
                </div>
              </div>
            </div>
          </div>
