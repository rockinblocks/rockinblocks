...
export const CallToAction: FC<ICallToActionProps> = (props): JSX.Element => {
  ...
  return (
    <div className="bg-slate-50 px-6 py-16 lg:py-32">
      <div className="container mx-auto">
        <div>
          <h2 className="text-center text-3xl lg:text-6xl font-bold mb-6 max-w-2xl mx-auto">
            {heading}
          </h2>
          <p className="text-center text-xl text-slate-500 max-w-xl mx-auto mb-6 lg:mb-12 antialised">
            {content}
          </p>
        </div>
        <div className="flex my-6 justify-center mb-6 lg:mb-12">
          ...
          <div className="px-6 border-solid border-l-2 border-l-slate-100">
            <div className="w-24 lg:w-36 relative">
              <svg
          ...
          <div className="flex pl-6 border-solid border-l-2 border-l-slate-100">
            <div className="inline w-6 lg:w-10">
              <svg
                viewBox="0 0 410 404"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="inline">
              <span className="text-2xl font-semibold pl-2 relative top-0.5">
                Vite
              </span>
            </div>
          </div>
